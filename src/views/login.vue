...
<div class="login-main">
     <div class="login-title">
            ...
            <el-form-item class="login-el-btn">
              <el-button type="primary" @click.native.prevent="handleSubmit2" :loading="logining" class="login-btn">{{$t('loginpage.login')}}</el-button>
          ...
          <div class="footer">
            ...
            <div class="language-switch" >
                    <el-dropdown trigger="hover" class="el-dropdown-item" style="padding: 10px 0px 30px 0px;color: white;">
                    <span class="el-dropdown-link" style="display: inline-flex;align-items: baseline;"> 
                       <img  height="12px"  class="imgswitch" :src="imgurl" />
                     <span >{{$t('language.name')}}</span><img src="../assets/images/arrow1.png" height="10px;" width="15px">
                    </span>
...
.form-dis{color:#000;font-weight: bold;text-align:left}
.input-vl{width: 100%;height:45px; border-radius: 5px;}
  }
