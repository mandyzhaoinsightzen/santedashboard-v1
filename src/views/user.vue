    ...
    export default {
        data: function () {
            return {
                ...
                columns:[
                    {title:"Code",field:'album'},
                    {title:"Account",field:'name'},
                    {title:"Organization",field:'time'},
                    {title:"Role Type",field:'singer'},
                    {title:"Create Data",field:'time'},
                ]
            }
        },
        methods:{
...
.dataTable{margin:30px auto;width: 80%;position: absolute;height: 300px;}
</style>